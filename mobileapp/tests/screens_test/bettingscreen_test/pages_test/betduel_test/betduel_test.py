...
Builder.load_file('tests/screens_test/bettingscreen_test/pages_test/betduel_test/betduel_test.kv')
...
class TestBetDuelPage:
    ...
    def test_display_message(self):
        error = {"error_message":"couldn't create bet"}
        fail = {}
        assert self.object_to_test.display_message(None, error) == "couldn't create bet"
        assert self.object_to_test.display_message(None, fail) == "Connexion avec le serveur impossible"
